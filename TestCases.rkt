...
(define tests
  ...
  (check-equal? (eval-exp (with* 
                          (list (cons "f" (num 2)) (cons "y" (var "f"))) 
                          (plus (var "f") (plus (var "y") (num 3))))) 
                (num 7) "test72")
  ...
  (check-equal? 
    (bool #t)
    (eval-exp (with* 
              (list (cons "f" (num 2)) (cons "y" (bool #t)))
              (ifneq (var "f") (num 2) (bool #f) (var "y"))))
    "test79")
  ...
  (check-equal? (eval-exp (value "Donald Knuth" 
                            (record (key "Donald Knuth" (num 1)) 
                                    (record (key "John McCarthy" (num 2)) 
                                            (record (key "Barbara Liskov" (num 3)) 
                                                    (munit)))))) 
    (num 1) "test132")

  (check-equal? (eval-exp (value "John McCarthy" 
                            (record (key "Donald Knuth" (num 1)) 
                                    (record (key "John McCarthy" (num 2)) 
                                            (record (key "Barbara Liskov" (num 3)) 
                                                    (munit)))))) 
  ...
  (check-equal? (eval-exp (value "Barbara Liskov" 
                            (record (key "Donald Knuth" (num 1)) 
                                    (record (key "John McCarthy" (num 2)) 
                                            (record (key "Barbara Liskov" (num 3)) 
                                                    (munit)))))) 
  ...
  (check-equal? (eval-exp (letrec "is-even" 
                                  (lam null "n" (orelse (iseq (var "n") (num 0)) (apply (var "is-odd") (minus (var "n") (num 1))))) 
                                  "is-odd" 
                                  (lam null "n" (andalso (neg (iseq (var "n") (num 0))) (apply (var "is-even") (minus (var "n") (num 1))))) 
                                  (apply (var "is-odd") (num 11))))
    (bool #t) "test138")
